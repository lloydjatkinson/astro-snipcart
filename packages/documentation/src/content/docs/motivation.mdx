---
title: Motivation
description: Astro Snipcart aims to accelerate the rapid creation of e-commerce with Astro and Snipcart
---
...
* Provide an additional set of Astro components that also implement client side functionality
...
![Astro Snipcart](../../assets/design-system-example-1.png "Astro Snipcart")
