...
![Astro Snipcart](../../../assets/data-storage.png "Astro Snipcart")
...
#### What about other scenarios, CMS, headless CMS, database, CSV, backend API, etc?
